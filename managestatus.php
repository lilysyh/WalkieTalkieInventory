...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16" >List of Status</div>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
            ...
            <div class="table-responsive" style="overflow-x:auto; width: 100%;">
                ...
                foreach ($statusData as $row) {
                    echo "<tr>";
                    echo "<td style='vertical-align: middle;'>" . $row["s_name"] . "</td>";
                    echo "<td style='vertical-align: middle;'>"; 
                    // Edit and delete buttons side by side
                    echo "<div class='action-buttons'>";
                    echo "<a href='add_status.php' class='add-button'><i class='fas fa-plus-circle'></i></a>";
                    echo "<a href='edit_status.php?id=" . $row["s_name"] . "' class='edit-button'><i class='fas fa-pencil-alt'></i></a>";
                  
                    echo "<a onclick='confirmDelete(\"" . $row["s_name"] . "\")' class='delete-button'><i class='fas fa-trash-alt'></i></a>";                 
