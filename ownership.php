...
if ($ownershipResult->num_rows > 0) {
    while ($row = $ownershipResult->fetch_assoc()) {
        $ownershipData[] = array(
            'o_type' => $row['o_type']
        );
    }
...
<div class="w3-top">
    <div class="w3-white w3-xlarge" style="max-width:1200px;margin:auto">
        ...
        <div class="w3-center w3-padding-16" >List of Ownership</div>
    ...
    <div class="w3-main w3-content w3-padding" style="max-width:1200px;margin-top:100px">
            ...
            <div class="table-responsive" style="overflow-x:auto; width: 100%;">
                ...
                foreach ($ownershipData as $row) {
                    echo "<tr>";
                    echo "<td style='vertical-align: middle;'>" . $row["o_type"] . "</td>";
                    echo "<td style='vertical-align: middle;'>"; 
                    // Edit and delete buttons side by side
                    echo "<div class='action-buttons'>";
                    echo "<a href='add_ownership.php' class='add-button'><i class='fas fa-plus-circle'></i></a>";
                    echo "<a href='edit_ownership.php?id=" . $row["o_type"] . "' class='edit-button'><i class='fas fa-pencil-alt'></i></a>";
                  
                    echo "<a onclick='confirmDelete(\"" . $row["o_type"] . "\")' class='delete-button'><i class='fas fa-trash-alt'></i></a>";                 
...
function confirmDelete(id) {
    ...
    if (confirm("Are you sure you want to delete the ownership record?")) {
        // Redirect to delete script with the record ID if the user confirms
        window.location.href = "delete_ownership.php?id=" + id;
    }
}
